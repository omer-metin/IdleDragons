...
const HUD = () => {
    ...
    return (
        <div style={{
            ...
            <div className="glass-panel" style={{ textAlign: 'center', padding: '0.5rem 2rem', borderRadius: 'var(--radius-lg)', borderTopLeftRadius: 0, borderTopRightRadius: 0, marginTop: '-1rem' }}>
